...
public class ContosoTestContainer extends TestContainer {

    public ContosoTestContainer() {
        super();
    ...
    public static class Common extends ContosoTestContainer {

        public static final ContosoTestContainer.Common INSTANCE = new ContosoTestContainer.Common();
